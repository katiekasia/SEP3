...
public final class DoctorGrpc {
  ...
  public static final io.grpc.MethodDescriptor<doctor.grpc.AddPrescriptionRequest,
      ...
      io.grpc.MethodDescriptor.<doctor.grpc.AddPrescriptionRequest, doctor.grpc.Response>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<doctor.grpc.GetAppointmentByIdReq,
      doctor.grpc.AppointmentInfoD> METHOD_GET_APPOINTMENT_BY_ID =
      io.grpc.MethodDescriptor.<doctor.grpc.GetAppointmentByIdReq, doctor.grpc.AppointmentInfoD>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "Doctor", "getAppointmentById"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              doctor.grpc.GetAppointmentByIdReq.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              doctor.grpc.AppointmentInfoD.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<doctor.grpc.PatientCprRequest,
      doctor.grpc.GetPrescriptionsByCprResponse> METHOD_GET_PRESCRIPTIONS_BY_CPR =
      io.grpc.MethodDescriptor.<doctor.grpc.PatientCprRequest, doctor.grpc.GetPrescriptionsByCprResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "Doctor", "getPrescriptionsByCpr"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              doctor.grpc.PatientCprRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              doctor.grpc.GetPrescriptionsByCprResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class DoctorImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAppointmentById(doctor.grpc.GetAppointmentByIdReq request,
        io.grpc.stub.StreamObserver<doctor.grpc.AppointmentInfoD> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_APPOINTMENT_BY_ID, responseObserver);
    }

    /**
     */
    public void getPrescriptionsByCpr(doctor.grpc.PatientCprRequest request,
        io.grpc.stub.StreamObserver<doctor.grpc.GetPrescriptionsByCprResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_PRESCRIPTIONS_BY_CPR, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            METHOD_GET_APPOINTMENT_BY_ID,
            asyncUnaryCall(
              new MethodHandlers<
                doctor.grpc.GetAppointmentByIdReq,
                doctor.grpc.AppointmentInfoD>(
                  this, METHODID_GET_APPOINTMENT_BY_ID)))
          .addMethod(
            METHOD_GET_PRESCRIPTIONS_BY_CPR,
            asyncUnaryCall(
              new MethodHandlers<
                doctor.grpc.PatientCprRequest,
                doctor.grpc.GetPrescriptionsByCprResponse>(
                  this, METHODID_GET_PRESCRIPTIONS_BY_CPR)))
          .build();
    }
  }
  ...
  public static final class DoctorStub extends io.grpc.stub.AbstractStub<DoctorStub> {
    ...
    public void getAppointmentById(doctor.grpc.GetAppointmentByIdReq request,
        io.grpc.stub.StreamObserver<doctor.grpc.AppointmentInfoD> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_APPOINTMENT_BY_ID, getCallOptions()), request, responseObserver);
    }
    ...
    public void getPrescriptionsByCpr(doctor.grpc.PatientCprRequest request,
        io.grpc.stub.StreamObserver<doctor.grpc.GetPrescriptionsByCprResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_PRESCRIPTIONS_BY_CPR, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DoctorBlockingStub extends io.grpc.stub.AbstractStub<DoctorBlockingStub> {
    ...
    /**
     */
    public doctor.grpc.AppointmentInfoD getAppointmentById(doctor.grpc.GetAppointmentByIdReq request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_APPOINTMENT_BY_ID, getCallOptions(), request);
    }

    /**
     */
    public doctor.grpc.GetPrescriptionsByCprResponse getPrescriptionsByCpr(doctor.grpc.PatientCprRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_PRESCRIPTIONS_BY_CPR, getCallOptions(), request);
    }
  }
  ...
  public static final class DoctorFutureStub extends io.grpc.stub.AbstractStub<DoctorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<doctor.grpc.AppointmentInfoD> getAppointmentById(
        doctor.grpc.GetAppointmentByIdReq request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_APPOINTMENT_BY_ID, getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<doctor.grpc.GetPrescriptionsByCprResponse> getPrescriptionsByCpr(
        doctor.grpc.PatientCprRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_PRESCRIPTIONS_BY_CPR, getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_GET_PATIENTS_BY_DOCTOR_ID = 4;
  private static final int METHODID_ADD_PRESCRIPTION = 5;
  private static final int METHODID_GET_APPOINTMENT_BY_ID = 6;
  private static final int METHODID_GET_PRESCRIPTIONS_BY_CPR = 7;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_APPOINTMENT_BY_ID:
          serviceImpl.getAppointmentById((doctor.grpc.GetAppointmentByIdReq) request,
              (io.grpc.stub.StreamObserver<doctor.grpc.AppointmentInfoD>) responseObserver);
          break;
        case METHODID_GET_PRESCRIPTIONS_BY_CPR:
          serviceImpl.getPrescriptionsByCpr((doctor.grpc.PatientCprRequest) request,
              (io.grpc.stub.StreamObserver<doctor.grpc.GetPrescriptionsByCprResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (DoctorGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_GET_APPOINTMENT_BY_ID)
              .addMethod(METHOD_GET_PRESCRIPTIONS_BY_CPR)
              .build();
        }
      }
    }
